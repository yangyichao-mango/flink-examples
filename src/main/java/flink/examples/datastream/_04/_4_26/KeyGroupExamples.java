package flink.examples.datastream._04._4_26;
...
public class KeyGroupExamples {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<InputModel> transformation = app1Source
                // 指定数据传输策略为 keyBy
                .keyBy(new KeySelector<InputModel, Integer>() {
                    @Override
                    public Integer getKey(InputModel inputModel) throws Exception {
                        return inputModel.getIndexOfSourceSubTask();
                    }
                })
