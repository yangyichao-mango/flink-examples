package flink.examples.datastream._04._4_21;
...
public class PunctuatedStrategyExamples {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<OutputModel> transformation = app1Source
                .assignTimestampsAndWatermarks(
                        WatermarkStrategy
                                .<InputModel>forGenerator(
                                        new WatermarkStrategy<flink.examples.datastream._04._4_21.PunctuatedStrategyExamples.InputModel>() {
                                            @Override
                                            public WatermarkGenerator<flink.examples.datastream._04._4_21.PunctuatedStrategyExamples.InputModel> createWatermarkGenerator(
                                                    WatermarkGeneratorSupplier.Context context) {
                                                return new WatermarkGenerator<flink.examples.datastream._04._4_21.PunctuatedStrategyExamples.InputModel>() {
                                                    @Override
                                                    public void onEvent(
                                                            flink.examples.datastream._04._4_21.PunctuatedStrategyExamples.InputModel inputModel,
