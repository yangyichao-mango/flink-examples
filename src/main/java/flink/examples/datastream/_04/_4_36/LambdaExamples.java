...
public class LambdaExamples {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TypeInformation<UserDefinedSource> o = TypeInformation.of(UserDefinedSource.class);
        ...
        // 2.(2) 转换数据
        DataStream<Tuple2<String, String>> transformation = source.map(v -> Tuple2.of("1", v));

        // 2.(3) 写出数据到自定义 Sink 中
        DataStreamSink<Tuple2<String, String>> sink = transformation.print();
