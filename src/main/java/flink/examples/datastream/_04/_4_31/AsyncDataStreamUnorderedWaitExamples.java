//package flink.examples.datastream._04._4_31;
//
...
//            final Future<String> result = client.query(input.getCounter());
//
...
//        }
//
//        // 建议一定要重写 timeout，默认的 timeout 实现是直接抛出异常，会导致 Flink 任务重启
//        @Override
//        public void timeout(InputModel input, ResultFuture<Tuple2<InputModel, String>> resultFuture) throws Exception {
//            resultFuture.complete(Collections.singleton(new Tuple2<>(input, "UNKNOWN")));
//        }
//    }
//
